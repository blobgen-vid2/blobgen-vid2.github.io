function openTab(evt, tabName) {
    ...
    // }
    tabcontent1 = document.getElementById("TC-Bench");
    tabcontent1.style.display = "none";
    tabcontent2 = document.getElementById("T2V-CompBench");
    tabcontent2.style.display = "none";
    tabcontent3 = document.getElementById("ScanNet++");
    tabcontent3.style.display = "none";
    tabcontent4 = document.getElementById("YTVIS");
    ...
    tablink2 = document.getElementById("tablink-scannetpp");
    tablink2.className = tablink2.className.replace(" active", "");
    tablink3 = document.getElementById("tablink-t2v-compbench");
    tablink3.className = tablink3.className.replace(" active", "");
    tablink4 = document.getElementById("tablink-tc-bench");
